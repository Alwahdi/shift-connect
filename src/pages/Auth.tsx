...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen gradient-hero flex items-center justify-center p-4 py-8 md:py-12">
      <motion.div
      ...
      >
        ...
        <Link to="/" className="flex items-center justify-center gap-3 mb-6 md:mb-8">
          ...
          <span className="font-bold text-2xl md:text-3xl text-primary-foreground drop-shadow-lg">SyndeoCare</span>
        </Link>

        {/* Card */}
        <div className="bg-card/95 backdrop-blur-sm rounded-2xl md:rounded-3xl border border-border/50 shadow-2xl p-6 md:p-8">
          {mode === "login" ? (
            <>
