...
export const semantics = {
  ...
  light: {
    ...
    feedback: {
      ...
      infoForeground: { 
        ...
        resolvedValue: primitives.color.sky[0]?.$value || primitives.color.neutral[0].$value,
      },
      infoMuted: { 
  ...
  dark: {
    ...
    border: {
      ...
      focus: { $value: "{primitives.color.green.400}", resolvedValue: primitives.color.green[400].$value },
    },
    text: {
      ...
      brand: { $value: "{primitives.color.green.400}", resolvedValue: primitives.color.green[400].$value },
      link: { $value: "{primitives.color.green.300}", resolvedValue: primitives.color.green[300].$value },
    },
  },
  ...
  gradient: {
    primary: {
      $value: "linear-gradient(135deg, {primitives.color.green.500} 0%, {primitives.color.green.700} 100%)",
    ...
    brand: {
      $value: "linear-gradient(135deg, {primitives.color.green.500} 0%, {primitives.color.teal.500} 100%)",
